...
@[app.fields,isFilter&!isRangeFilter]@
	        tmp#[app.component,PascalCase]#Filter.#[name]# = #[app.table]#.#[field]#
@[end]@@[app.fields,isFilter&isRangeFilter]@
	        tmp#[app.component,PascalCase]#Filter.#[name]#Initial = #[app.table]#.#[field]#
            tmp#[app.component,PascalCase]#Filter.#[name]#Final = #[app.table]#.#[field]#
@[end]@.
