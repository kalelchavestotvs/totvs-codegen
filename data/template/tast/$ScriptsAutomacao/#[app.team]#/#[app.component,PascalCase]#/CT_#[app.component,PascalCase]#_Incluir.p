...
@[app.fields,isPrimary]@
            tmp#[app.component,AblTempTable,PascalCase]#.#[field]#  = tmp#[app.component,AblTempTable,PascalCase]#.#[field]# + ?[ablType=character]?"Z"?[end]??[!ablType=character]?1?[end]?
            GPS_#[app.component,PascalCase]#.#[field]# = tmp#[app.component,AblTempTable,PascalCase]#.#[field]#
@[end]@.
    end.
